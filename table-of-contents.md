...
2. **Counting with Wires: Binary**
   - The problem: 256 patterns is not the same thing as 256 numbers
   - The trick you already know: why 437 means four hundred and thirty-seven
   - An odometer whose wheels have only two positions
   - The same eight wires as a number, a letter, a colour
   - Meaning is an agreement we make, not a property of the wire
